"""Simple test to verify packaging configuration."""
...
def test_pyproject_has_correct_entry_point() -> None:
...
def test_package_data_configured() -> None:
...
def test_build_script_exists() -> None:
    ...
    script = Path(__file__).parent.parent / "scripts" / "build_frontend.py"
